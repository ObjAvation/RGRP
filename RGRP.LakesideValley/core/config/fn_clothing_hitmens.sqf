#include <macro.h>
/*
	File: fn_clothing_hitmens.sqf
	
	
	Description:
	Master configuration file for Hitmen Squad Gang Clothing.
*/
private["_filter"];
_filter = param [0,0,[0]];
...
//Shop Title Name
ctrlSetText[3103,"Hitmen Squad Gang Clothing"];
...
switch (_filter) do
{
	...
	case 0:
	{
		...
		[
			...
			["TRYK_U_B_AOR2_OD_R_CombatUniform",nil,550],
			["TRYK_U_B_OD_BLK",nil,550],
			//koil added
