...
switch (_shop) do
{
	...
	case "med_shop":
	{
		_return = 
		[
			["cg_ambulanceexpansion",2500],
			["A3L_AmberLamps",2500],
			["DAR_TahoeEMS",2500],
			["AM_Holden_EMS",2500],
			["cg_evoems1",2500],
			["cg_merc_atego_firetruck_reg",2500]
		];
	};
	case "med_air_hs": {
		_return = 
	...
	case "cop_car":
	{
		...
		[	
			...
			["cg_CVPISH",2500],
			["cg_TaurusSS2",2500],
			["DAR_ExplorerSheriff",2500],
			["charger_sh_skinned",2600],
			["cg_ducati_pol_reg",3500],
			
			//Trooper
			["cg_cvpitrooper",2500],
			["cg_taurustrooper",2500],
			["cg_charger_trp_skinned",2500],
			
			//D.O.C
			["A3L_TaurusCO1",2500],
			["A3L_CVPIFPBDOC",2500],
			["charger_cor_skinned",2500],
			["A3L_jailBus",3000],

			//S.E.R.T
			["ivory_isf_unmarked",2500],
			["ivory_m3_unmarked",2500],
			["charger_sert",2500],
			["cg_h2_sert",2500],
			["SWATBearcat_01",4500],
			["B_T_LSV_01_unarmed_F",2500],
			["cg_jeep_cherokee_noir",2500],
			
			//High Command
			["ivory_wrx_unmarked",2500],
			["ivory_isf_unmarked",2500],
			["DAR_ExplorerPoliceStealth",2500],
			["A3L_Charger_Patrol",2500]
		];
	};
	case "cop_car1":
	{
	...
	case "cop_air":
	{
		...
		[			
			["Sheriff_helo",45000],
			["Sheriff_Chopper",45000],
			["MELB_H6M",45000],
			["B_Heli_Transport_03_unarmed_F",60000]
		];
	};
	case "cop_airhq":
	{
