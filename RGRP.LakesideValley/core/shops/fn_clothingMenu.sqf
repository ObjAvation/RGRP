...
if((_this select 3) == "sas" && !license_civ_sas) exitWith {[localize "STR_Shop_Notasas", false] spawn domsg; closeDialog 0;};
if((_this select 3) == "jack" && !license_civ_jack) exitWith {[localize "STR_Shop_Notajack", false]spawn domsg; closeDialog 0;};
if((_this select 3) == "lhd" && !license_civ_lhd) exitWith {[localize "STR_Shop_NotaLHD", false]spawn domsg; closeDialog 0;};
if((_this select 3) == "kirby" && !license_civ_kirby) exitWith {[localize "STR_Shop_NotaKirby", false]spawn domsg; closeDialog 0;};
if((_this select 3) == "jack" && !license_civ_jack) exitWith {[localize "STR_Shop_NotaPhillipson", false]spawn domsg; closeDialog 0;};
if((_this select 3) == "thomasf" && !license_civ_thomasf) exitWith {[localize "STR_Shop_NotaThomas", false]spawn domsg; closeDialog 0;};
if((_this select 3) == "isf" && !license_civ_isf) exitWith {[localize "STR_Shop_Notaisf", false]spawn domsg; closeDialog 0;};
