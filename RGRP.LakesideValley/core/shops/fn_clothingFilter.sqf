...
_clothes = switch (life_clothing_store) do
{
	...
	case "lhd": {[_selection] call life_fnc_clothing_lhd;};
	case "thomasf": {[_selection] call life_fnc_clothing_thomasf;};
	case "kirby": {[_selection] call life_fnc_clothing_kirby;};
	case "trussell": {[_selection] call life_fnc_clothing_trussell;};
	case "ssf": {[_selection] call life_fnc_clothing_ssf;};
	case "hitmens": {[_selection] call life_fnc_clothing_hitmens;};
	case "jack": {[_selection] call life_fnc_clothing_jack;};
};
